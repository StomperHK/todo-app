...
export function LandingPage() {
  ...
  return (
    <>
      <Header />
      <main className={`full-height-minus-header overflow-x-hidden`}>
        <div className="max-w-7xl m-auto pb-8">
          ...
          <ul data-js-animations="opacity-5 -translate-y-20" className={`flex justify-center gap-6 items-center px-6 opacity-5 -translate-y-20 transition-transform-opacity delay-500 duration-500 max-700:flex-col max-700:pb-12`}>
            <li className="flex items-center gap-3 border-2 border-zinc-600 bg-zinc-800 px-2 py-1 rounded-[4px] max-700:p-3 max-700:w-[260px]">
              <UserX size={20} />
