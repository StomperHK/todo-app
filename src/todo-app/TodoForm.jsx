    ...
    <>
      <form onSubmit={handleAddTodo} className="mb-5">
        <div className="flex items-center gap-3 mb-5">
          ...
          <IconButton type="button" onClick={handleToggleDescription} aria-label="exibir campo de descrição" title="exibir campo de descrição" className="rounded-full"><ChevronDown size={20} className={descriptionIsVisible ? "rotate-180" : ""} /></IconButton>
        ...
        { descriptionIsVisible && <Input textarea placeholder="descrição da tarefa" name="todo-description" className="w-full" />}
      </form>
    </>
  )
}